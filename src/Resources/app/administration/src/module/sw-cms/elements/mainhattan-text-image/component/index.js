...
import template from './sw-cms-el-mainhattan-text-image.html.twig';
import './sw-cms-el-mainhattan-text-image.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('mainhattan-text-image');
            this.initElementData('mainhattan-text-image');
        },
        updateDemoValue() {
            if (this.element.config.heading.source === 'mapped') {
                this.demoValue = this.getDemoValue(this.element.config.heading.value);
            }
        },
        ...
        emitChanges(content) {
            if (content !== this.element.config.heading.value) {
                this.element.config.heading.value = content;
